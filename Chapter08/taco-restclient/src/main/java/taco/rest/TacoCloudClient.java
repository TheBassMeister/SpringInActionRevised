...
public class TacoCloudClient {
  ...
  public Ingredient getIngredientById(String ingredientId) {
    ...
    }catch(HttpClientErrorException hpEx){
      log.info("Ingredient with id "+ingredientId+" does not exist");
      return null;
    }
  }
  ...
  public Collection<Ingredient> getAllIngredients() {
    Resources<Ingredient> ingredientsResources=rest.exchange("http://localhost:8080/api/ingredients",
            HttpMethod.GET, null, new ParameterizedTypeReference<Resources<Ingredient>>() {})
        .getBody();
    return ingredientsResources.getContent();
  }
